...
public enum ErrorAbilityT {
	...
	ErrorAbilityT(String errorCode, String errorDescription) {
		this.errorCode = errorCode;
		this.errorDescription = errorDescription;
	}
	
	public AdressException buildEmployeeException() {
		return buildEmployeeException(null);
	}
	
	public AdressException buildEmployeeException(String msg) {
		String nueva = StringUtils.defaultIfEmpty(msg, "");
		return new AdressException(errorCode,errorDescription + " : " + nueva);
	}
