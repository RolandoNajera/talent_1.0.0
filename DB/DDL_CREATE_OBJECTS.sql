...
CREATE UNIQUE INDEX idx_experience_id ON Experience (id);
ALTER TABLE Experience ADD CONSTRAINT FK_experience_profile FOREIGN KEY (idProfile) REFERENCES Profile(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE UNIQUE INDEX idx_ability_id ON Ability (id);
ALTER TABLE Ability ADD CONSTRAINT FK_ability_profile FOREIGN KEY (idProfile) REFERENCES Profile(id) ON UPDATE CASCADE ON DELETE CASCADE;
